...
QLEARN = "/home/common/ji-bao-lin/taxi/summary.json"
SARSA = "/home/common/ji-bao-lin/taxi/results/sarsa/summary.json"
OUT_PLOT = f"single_qlearn_vs_sarsa_boxplot_{CONFIG_KEY}.png"

def load_rewards(path, config_key=f"{CONFIG_KEY}_static"):
    with open(path) as f:
        data = json.load(f)
...
def make_boxplot(q_rewards, s_rewards, out_path):
    ...
    ax.set_title(f"[No decay epsilon] Q-learning vs SARSA — {CONFIG_KEY}, single-passenger taxi\n(12 seeds each)")
