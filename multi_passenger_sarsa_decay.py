"""
Multi-Passenger Taxi — SARSA with Epsilon Decay
"""
...
# Output directory
# ---------------------------------------------------------------------------
OUTPUT_DIR = Path("results/sarsa_decay/multi")
...
def train_sarsa(
    ...
    """Train a SARSA agent with epsilon decay."""
    np.random.seed(seed)
    random.seed(seed)
    ...
    # epsilon is set per-episode in the outer loop and read by select_action via closure
    ...
    for episode in range(episodes):
        ...
        current_epsilon = epsilon_start + (epsilon_end - epsilon_start) * frac
        ...
        while not (done or truncated):
            ...
            if not (done or truncated):
                ...
                next_action = select_action(next_state, info)
