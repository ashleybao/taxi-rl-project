...
output_dir = Path("results/10by10map/q_learning")
...
plt.title("Exploration Strategy and Action Masking Effects — Q-Learning (10×10)")
plt.legend()
...
ax1.set_title("Effect of Decaying ε Schedule — Q-Learning (10×10)")
ax1.legend()
