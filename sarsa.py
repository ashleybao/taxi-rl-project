...
output_dir = Path("results/sarsa")
output_dir.mkdir(parents=True, exist_ok=True)

checkpoints_dir = Path("results/sarsa/checkpoints")
checkpoints_dir.mkdir(parents=True, exist_ok=True)

qtables_dir = Path("results/sarsa/q_tables")
qtables_dir.mkdir(parents=True, exist_ok=True)

rewards_dir = Path("results/sarsa/rewards")
...
ax1.set_title("Effect of Decaying ε Schedule - SARSA")
ax1.legend()
